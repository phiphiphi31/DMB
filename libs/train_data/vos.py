...
from libs.train_data.image_loader import default_image_loader
...
class Vos(BaseDataset):
    ...
    def __init__(self, root=None, image_loader=default_image_loader, vid_ids=None, split=None):
        ...
        """
        vos_dir = '/home/jaffe/Titanspace/datasets/dataset/testdataset/dataset/youtubevos2018/youtubevos2018/train'
        root = vos_dir
